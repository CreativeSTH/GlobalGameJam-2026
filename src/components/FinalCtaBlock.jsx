...
export default function FinalCtaBlock({ scrollProgress }) {
    ...
    // Fades in smoothly, stays visible, then fades out before next section (0.96-1.0)
    const opacity = useTransform(scrollProgress, [0.80, 0.88, 0.96, 1], [0, 1, 1, 0]);
        ...
        >
            ...
            <div className="flex flex-col md:flex-row gap-6 mt-4">
                ...
                >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 245.371 220.736" className="w-8 h-8 mr-3 fill-current">
